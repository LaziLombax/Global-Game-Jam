...
public class CloudScapeGeneratorEditor : Editor
{
	...
	public void ScalePs(GameObject __parent_cs1, ParticleSystem __particles_cs1) {
		...
		serializedParticles.FindProperty("InitialModule.gravityModifier.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.strength.scalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.strength.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.strengthY.scalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.strengthY.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.strengthZ.scalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.strengthZ.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.frequency").floatValue /= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.sizeAmount.scalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.sizeAmount.minScalar").floatValue *= tar._scaleMultiplier;
		...
		serializedParticles.FindProperty("NoiseModule.rotationAmount.scalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.rotationAmount.minScalar").floatValue *= tar._scaleMultiplier;
		...
		serializedParticles.FindProperty("NoiseModule.positionAmount.scalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("NoiseModule.positionAmount.minScalar").floatValue *= tar._scaleMultiplier;
		...
		serializedParticles.FindProperty("LightsModule.rangeCurve.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("InitialModule.startSize.scalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("InitialModule.startSize.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("InitialModule.startSizeY.scalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("InitialModule.startSizeY.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("InitialModule.startSizeZ.scalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("InitialModule.startSizeZ.minScalar").floatValue *= tar._scaleMultiplier;
		...
		serializedParticles.FindProperty("InitialModule.startSpeed.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("VelocityModule.x.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("VelocityModule.y.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("VelocityModule.z.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("ClampVelocityModule.x.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("ClampVelocityModule.y.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("ClampVelocityModule.z.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("ForceModule.x.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("ForceModule.y.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("ForceModule.z.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("ClampVelocityModule.magnitude.minScalar").floatValue *= tar._scaleMultiplier;
		serializedParticles.FindProperty("ShapeModule.m_Scale").vector3Value *= tar._scaleMultiplier;
		serializedParticles.FindProperty("ShapeModule.radius.value").floatValue *= tar._scaleMultiplier;
